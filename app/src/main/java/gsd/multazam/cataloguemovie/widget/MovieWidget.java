...
public class MovieWidget extends AppWidgetProvider {
    public static final String TOAST_ACTION = "gsd.multazam.cataloguemovie.TOAST_ACTION";
    public static final String EXTRA_ITEM = "gsd.multazam.cataloguemovie.EXTRA_ITEM";
