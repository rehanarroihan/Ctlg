...
public class MovsAdapter extends RecyclerView.Adapter<MovsAdapter.ViewHolder> {
    public static final String IMAGE_URL_BASE_PATH = "http://image.tmdb.org/t/p/w500";
    ArrayList<Movie> list;
    Context context;
    IMovieAdapter iMovieAdapter;

    public MovsAdapter(Context context, ArrayList<Movie> list, IMovieAdapter iMovieAdapter) {
        this.list = list;
